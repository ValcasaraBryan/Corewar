...
/*   Updated: 2019/07/06 14:21:01 by brvalcas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_op	g_op_tab[REG_NUMBER + 1] =
{
	...
	{"and", 3, 3, {T_REG | T_DIR | T_IND, T_REG | T_IND | T_DIR, T_REG}, AND,
		6, "et (and  r1,  r2,  r3   r1&r2 -> r3", 1, 0},
	{"or", 2, 3, {T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR, T_REG}, OR,
		6, "ou  (or   r1,  r2,  r3   r1 | r2 -> r3", 1, 0},
	{"xor", 3, 3, {T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR, T_REG}, XOR,
		6, "ou (xor  r1,  r2,  r3   r1^r2 -> r3", 1, 0},
	{"zjmp", 4, 1, {T_DIR}, ZJMP, 20, "jump if zero", 0, 1},
	{"ldi", 3, 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, LDI, 25,
		"load index", 1, 1},
	{"sti", 3, 3, {T_REG, T_REG | T_DIR | T_IND, T_DIR | T_REG}, STI, 25,
		"store index", 1, 1},
	{"fork", 4, 1, {T_DIR}, FORK, 800, "fork", 0, 1},
	{"lld", 3, 2, {T_DIR | T_IND, T_REG}, LLD, 10, "long load", 1, 0},
	{"lldi", 4, 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, LLDI, 50,
		"long load index", 1, 1},
